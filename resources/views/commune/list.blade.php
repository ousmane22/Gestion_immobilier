    ...
    <div class="container">
        <div class="block block-rounded col-md-12 mt-5">
            <ul class="nav nav-tabs nav-tabs-block" data-toggle="tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#add">Add Commune</a>
                </li>
            ...
            <div class="block-content tab-content">
                <div class="tab-pane active" id="list" role="tabpanel">
                    <h4 class="font-w400">
                        <div class="container">
                            <div class="card">
                                <div class="card-header text-white fw-5" style="background-color:#3177D5">Liste des Communes
                                    ...
                                    <table class="table table-stripped">
                                        ...
                                        @foreach ($commune as $communes)
                                            <tr>
                                                <td>{{ $communes->id }}</td>
                                                <td>{{ $communes->nom }}</td>
                                                <td>{{ $communes->departement->nom }}</td>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('store.commune') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Nom Commune:</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="departement_id" id="" class="form-control">
                                                    <option value="">Choose the Département</option>
                                                    @foreach ($departement as $d)
                                                        <option value="{{ $d->id }}">{{ $d->nom }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
